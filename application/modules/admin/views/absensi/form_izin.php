        ...
        <div class="panel panel-body">
          <div class="container">
            <div class="alert alert-warning">
              Anda Sudah Melakukan Izin
            </div>
            <center>
              <img src="<?php echo image_module('absensi', $has_izin['id'].'/'.$has_izin['foto']) ?>" class="img img-responsive" alt="">
            </center>
          </div>
        </div>
      ...
      <?php else: ?>
        <div class="panel panel-body">
          <center>
            ...
            <?php else: ?>
              <input type="hidden" name="jam_jadwal" value="00:00">
            <?php endif ?>
