...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini">Face</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Face</b> Print</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content" id="videodiv">
...
<!-- FastClick -->
<script src="<?php echo base_url('templates/AdminLTE');?>/assets/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
